...
|---|---|---|---|---|
| Balanced Random Forest | 0.81 | 0.31 | 4 | FP=38 (alarm fatigue risk); FN=0 confirmed on external validation with XGBoost |
...
This reflects a structural limitation of rule-based pseudo-labeling.
...
Recall = 100% was achieved, but improving Precision requires addressing the root causes listed below.
